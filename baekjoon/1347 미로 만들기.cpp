/* 2022-03-18  21:03
백준 1347번 미로 만들기 || 실버 4
https://www.acmicpc.net/problem/1347

분야 : [ 시뮬레이션, 구현, 문자열 ]

================================
먼저 이동한 스텝에 대해 먼저 좌표 계산이 되야하므로
FIFO 구조를 가지고 있는 이동 경로를 queue로 관리하기로 하였다.

그리고 최소 좌표와 최대 좌표들을 관리하여
이동이 모두 끝났을 때, queue에서 빼내면서
'.'으로 표시하기로 하였다.
================================

시작시간 : **:**
종료시간 : **:**   ||  [ 시도횟수 : 1회  |  걸린시간 : 32분 ]
*/
